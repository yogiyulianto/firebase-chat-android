package com.yogiyulianto.pam.firebase.adapter;
...
import com.yogiyulianto.pam.firebase.R;
import com.yogiyulianto.pam.firebase.models.Chat;

import java.util.ArrayList;
import java.util.List;

public class ChatAdater extends RecyclerView.Adapter<ChatAdater.ViewHolder> {
    private List<Chat> chatList;
    private Context context;

    public ChatAdater(Context context) {
